...
4. **Princeton effort allocation** (Masís, Musslick, Cohen, PNAS 2025, [10.1073/pnas.2416720122](https://doi.org/10.1073/pnas.2416720122)): agents should sometimes spend effort where expected information gain is high, not only where immediate success probability is highest. Equal-budget MAS evidence (Kim et al., Nat. Mach. Intell. 2026, [10.1038/s42256-026-01268-y](https://doi.org/10.1038/s42256-026-01268-y)) says extra agents often *hurt* once a single capable worker exists.
